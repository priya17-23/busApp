...
<body>
    ...
    <script>
        ...
        function verifySingleUSN() {
            ...
            if (found) {
                ...
                `;
                function showPhotoModal(name, usn, photoUrl) {
    document.getElementById('studentDetailsContent').innerHTML = `
        <div class="text-center">
            <img src="${photoUrl}" alt="Student Photo" 
                 style="width:200px;height:200px;border-radius:10px;border:3px solid #28a745;">
    ...
    modal.show();
        ...
        function viewStudentDetails(usn) {
            ...
            // For now, we'll show a simple modal with available info
